...
import { useUpdateBook } from "../../../services/bookApi";
...
function EditBook() {
  ...
  const onSubmit = async (data: BookFormType) => {
    await mutateAsync({ book_id: bookId as string, data });
    navigate("/books/list");
  };
      ...
      <div className="flex flex-col w-full">
        <div className="mb-8">
          <div className="flex items-center gap-4 p-4">
            ...
            <h1 className="font-medium text-lg">Edit Book</h1>
          </div>
            ...
            <div className="border p-6 rounded-lg">
              <div className="flex flex-col gap-4">
                ...
                <div className="flex flex-col md:flex-row justify-end gap-4 pt-4">
                  <button
                    type="button"
                    className="w-full md:w-32 h-10 rounded bg-gray-300 text-black"
                    onClick={() => reset()}
                  >
                    Cancel
                  </button>
